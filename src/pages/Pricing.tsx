  ...
  return (
    <div className="relative min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-blue-500/20 selection:text-blue-900 py-16">
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <section className="max-w-4xl mx-auto border-2 border-cyan-500 rounded-2xl bg-gradient-to-br from-slate-950 via-slate-950 to-slate-900 p-6 sm:p-10 space-y-6 relative overflow-hidden shadow-xl shadow-cyan-500/5">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-slate-900 pb-6">
            <div className="space-y-2">
              ...
              <h2 className="text-2xl font-bold font-display tracking-tight text-white">Book an Engineering Sizing Call</h2>
            ...
            <div className="shrink-0 flex flex-col justify-center items-center md:items-end space-y-2 bg-slate-900 p-5 rounded-xl border border-slate-800">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-xs text-slate-400 leading-relaxed font-sans pt-2">
            <div className="space-y-1.5">
              <h4 className="text-white font-bold font-display">1. Why We Avoid Fixed Rates</h4>
            ...
            <div className="space-y-1.5">
              <h4 className="text-white font-bold font-display">2. Flat Retainers + Raw Compute</h4>
            ...
            <div className="space-y-1.5">
              <h4 className="text-white font-bold font-display">3. Risk-Free Proof-of-Concept</h4>
        ...
        <section className="max-w-4xl mx-auto border border-slate-900 rounded-2xl bg-white backdrop-blur-md p-6 sm:p-8 space-y-6">
          <div className="flex items-center gap-2.5 border-b border-slate-900 pb-4">
            <Calculator className="w-5 h-5 text-cyan-400" />
            <div>
              <h2 className="text-base font-bold font-display uppercase tracking-wider text-slate-900">Operational ROI Calculator</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
            ...
            <div className="md:col-span-6 space-y-4">
              ...
              <div className="p-3.5 bg-slate-50 border border-slate-900 rounded-lg text-[10.5px] leading-relaxed text-slate-400 font-sans">
            ...
            <div className="md:col-span-6 grid grid-cols-1 sm:grid-cols-3 gap-4 font-mono text-center">
              ...
              <div className="bg-slate-50 border border-slate-900 rounded-xl p-4 flex flex-col justify-center">
        ...
        <section className="space-y-6 max-w-6xl mx-auto">
          <div className="text-center max-w-xl mx-auto space-y-1">
            <h2 className="text-xl sm:text-2xl font-bold font-display tracking-tight text-slate-900">Illustrative Sizing Models</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
            ...
            <div className="border border-slate-900 rounded-2xl bg-white p-6 flex flex-col justify-between space-y-6 relative opacity-85 hover:opacity-100 transition-opacity">
              <div className="space-y-4">
                ...
                <h3 className="text-lg font-bold font-display text-slate-900">Starter Pilot</h3>
            ...
            <div className="border border-slate-900 rounded-2xl bg-white p-6 flex flex-col justify-between space-y-6 relative opacity-85 hover:opacity-100 transition-opacity">
              <div className="space-y-4">
                ...
                <h3 className="text-lg font-bold font-display text-slate-900">Growth Operational</h3>
                <p className="text-xs text-slate-400 leading-relaxed font-sans">
            ...
            <div className="border border-slate-900 rounded-2xl bg-white p-6 flex flex-col justify-between space-y-6 relative opacity-85 hover:opacity-100 transition-opacity">
              <div className="space-y-4">
                ...
                <h3 className="text-lg font-bold font-display text-slate-900">Enterprise Enclaves</h3>
                <p className="text-xs text-slate-400 leading-relaxed font-sans">
        ...
        <section className="max-w-3xl mx-auto text-center space-y-4 pt-4">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-xl border border-slate-900 bg-slate-50 text-[10.5px] text-slate-400 font-sans">

  ...
  return (
    <div className="relative min-h-screen bg-slate-950 text-slate-100 font-sans selection:bg-cyan-500/30 selection:text-cyan-200 py-16">
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="border border-slate-900 rounded-xl bg-slate-950/50 p-2 max-w-5xl mx-auto">
          ...
          >
            ...
            <div className="lg:col-span-7 space-y-6 flex flex-col justify-between">
              ...
              <div className="space-y-4">
                ...
                <h2 className="text-2xl sm:text-3xl font-bold font-display tracking-tight text-slate-100">{activeSolution.title}</h2>
                
                {/* Problems and Solutions block */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
                  <div className="bg-slate-950/40 border border-slate-900 rounded-lg p-4 space-y-1.5">
                  ...
                  <div className="bg-cyan-500/5 border border-cyan-500/20 rounded-lg p-4 space-y-1.5">
                    ...
                    <p className="text-xs text-cyan-100/80 font-sans leading-relaxed">{activeSolution.solution}</p>
                  </div>
                </div>
              ...
              <div className="pt-4 border-t border-slate-900">
                ...
                <div className="flex flex-wrap gap-1.5">
                  {activeSolution.mappedProducts.map((pName, idx) => (
                    <span key={idx} className="px-2.5 py-1 text-[10px] rounded-md border border-slate-800 bg-slate-900 text-slate-300 font-mono">
                      {pName}
                    </span>
                  ))}
                </div>
            ...
            <div className="lg:col-span-5 flex flex-col justify-between space-y-6">
              ...
              {/* Metrics Grid */}
              <div className="grid grid-cols-3 gap-4 border border-slate-900 rounded-xl bg-slate-950/60 p-4">
              ...
              <div className="border border-slate-900/80 rounded-xl bg-slate-950/80 p-5 space-y-4">
                <div className="flex items-center gap-2 border-b border-slate-900 pb-3">
                  <Terminal className="w-4 h-4 text-cyan-400 animate-pulse" />
                  <span className="text-xs font-mono font-bold text-slate-200">Autonomous Core Flow Diagram</span>
                </div>
                
                <div className="space-y-3 relative pl-4 border-l border-slate-900/80 py-1">
                  {activeSolution.sampleFlow.map((step, idx) => (
                    <div key={idx} className="relative group space-y-1">
                      ...
                      <p className="text-[11px] text-slate-300 leading-relaxed font-sans">{step}</p>
                    </div>
                  ))}
                </div>
              </div>

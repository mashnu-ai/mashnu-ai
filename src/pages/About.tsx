    ...
    <div className="relative min-h-screen bg-slate-950 text-slate-100 font-sans selection:bg-cyan-500/30 selection:text-cyan-200 py-16">
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch max-w-5xl mx-auto">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between p-6 sm:p-8 rounded-2xl border border-slate-900 bg-slate-950/40 relative overflow-hidden">
            ...
            <div className="space-y-4 relative z-10">
              ...
              <h2 className="text-2xl font-bold font-display tracking-tight text-slate-100">Kiran<br />CTO & Technical Founder</h2>
            ...
            <div className="border-t border-slate-900 pt-4 mt-6">
              <span className="text-xs font-semibold text-slate-300 block">Kiran</span>
              <span className="text-[10px] font-mono text-slate-500 uppercase tracking-widest">CTO / Founder, Mashnu AI</span>
            </div>
          </div>

          <div className="lg:col-span-7 border border-slate-900 rounded-2xl bg-slate-950/60 p-6 sm:p-8 flex flex-col justify-between relative overflow-hidden">
            ...
            <div className="space-y-4 relative z-10">
              ...
              <h3 className="text-lg font-bold font-display tracking-wide text-slate-100">Escaping the Brittle Consulting Cycle</h3>
            ...
            <div className="p-4 bg-slate-900/40 rounded-xl border border-slate-900/80 text-slate-400 flex items-center gap-3 mt-6">
        ...
        <section className="border border-slate-900 rounded-2xl bg-slate-950/40 backdrop-blur-md p-6 sm:p-10 max-w-5xl mx-auto space-y-6 relative overflow-hidden">
          ...
          <div className="flex items-center gap-3 border-b border-slate-900 pb-4">
            ...
            <div>
              <h3 className="text-base font-bold font-display tracking-wide text-slate-100">Why We Build Platforms, Not Projects</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-xs sm:text-sm text-slate-400 leading-relaxed font-sans">
            <div className="space-y-3">
              <h4 className="text-slate-200 font-bold font-display">Brittle Projects vs Permanent Platforms</h4>
              <p>
            ...
            <div className="space-y-3">
              <h4 className="text-slate-200 font-bold font-display">System Integrity & Continuous Value</h4>
              <p>
        ...
        <section className="space-y-8 max-w-5xl mx-auto">
          <div className="text-center max-w-xl mx-auto space-y-2">
            <h2 className="text-xl sm:text-2xl font-bold font-display tracking-tight text-slate-100">Our Core Disciplines</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="border border-slate-900 rounded-xl bg-slate-950/40 p-6 space-y-3">
              <div className="w-8 h-8 rounded bg-cyan-500/10 border border-cyan-500/20 flex items-center justify-center">
                <Code className="w-4 h-4 text-cyan-400" />
              </div>
              <h4 className="text-xs font-bold font-mono uppercase tracking-wider text-slate-100">Deterministic Graphs</h4>
            ...
            <div className="border border-slate-900 rounded-xl bg-slate-950/40 p-6 space-y-3">
              ...
              <h4 className="text-xs font-bold font-mono uppercase tracking-wider text-slate-100">Flat Pass-Through Integrity</h4>
              <p className="text-[11.5px] text-slate-400 leading-relaxed font-sans">
            ...
            <div className="border border-slate-900 rounded-xl bg-slate-950/40 p-6 space-y-3">
              ...
              <h4 className="text-xs font-bold font-mono uppercase tracking-wider text-slate-100">Strict Code Reciprocity</h4>
              <p className="text-[11.5px] text-slate-400 leading-relaxed font-sans">

...
const VISION_STAGES: StageItem[] = [
  {
    ...
    icon: <Workflow className="w-5 h-5 text-[#0071E3]" />,
  ...
  },
  {
    ...
    icon: <Cloud className="w-5 h-5 text-[#0071E3]" />,
  ...
  },
  {
    ...
    icon: <ShoppingBag className="w-5 h-5 text-[#0071E3]" />,
  ...
  },
  {
    ...
    icon: <BookOpen className="w-5 h-5 text-[#0071E3]" />,
  ...
  },
  {
    ...
    icon: <Binary className="w-5 h-5 text-[#0071E3]" />,
    ...
    <div className="relative min-h-screen bg-[#FBFBFD] text-[#1D1D1F] font-sans selection:bg-[#0071E3]/20 selection:text-[#0071E3] py-16 animate-fade-in">
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <section className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <h1 className="text-4xl sm:text-5xl font-semibold tracking-[-0.02em] text-[#1D1D1F] leading-tight">
            Our Multi-Stage Evolution Stance
          </h1>
          <p className="text-lg text-[#6E6E73] leading-relaxed max-w-2xl mx-auto">
        ...
        <section className="border border-[#E8E8ED] rounded-[28px] bg-white p-6 sm:p-10 space-y-6 max-w-4xl mx-auto shadow-sm">
          
          <div className="flex items-center gap-3 border-b border-[#E8E8ED] pb-4">
            <div className="w-10 h-10 rounded-lg bg-[#0071E3]/5 border border-[#0071E3]/10 flex items-center justify-center">
              <Compass className="w-5 h-5 text-[#0071E3]" />
            </div>
            <div>
              <h2 className="text-xl font-semibold tracking-tight text-[#1D1D1F]">Why Systems Engineering Moats Wrapper APIs</h2>
              <span className="text-[10px] font-semibold text-[#6E6E73] uppercase tracking-wider block mt-0.5">Stance on Tech-Sovereignty</span>
            </div>
          </div>
        ...
        <section className="max-w-4xl mx-auto border border-dashed border-[#D2D2D7] rounded-2xl p-6 bg-[#F5F5F7] text-center space-y-3">
          <div className="mx-auto w-12 h-12 rounded-xl bg-white border border-[#E8E8ED] flex items-center justify-center shadow-sm">
            <Compass className="w-5 h-5 text-[#0071E3]" />
          </div>
          <div className="space-y-1">
            ...
            <p className="text-xs text-[#6E6E73] max-w-lg mx-auto leading-relaxed">
        ...
        <section className="space-y-6 max-w-7xl mx-auto">
          <div className="text-center max-w-xl mx-auto space-y-1">
            <h2 className="text-2xl font-semibold tracking-tight text-[#1D1D1F]">The Roadmap Sequence</h2>
          ...
          <div className="p-5 border border-[#E8E8ED] rounded-[24px] bg-[#F5F5F7]">
                ...
                return (
                  <button
                    ...
                    className={`p-3 rounded-xl border text-left transition-all duration-200 relative flex flex-col justify-between cursor-pointer ${
                      isActive
                        ? 'border-[#0071E3] bg-white scale-[1.03] z-10 shadow-sm'
                        : 'border-[#E8E8ED] bg-white/60 hover:border-[#D2D2D7]'
                    }`}
                  >
                    <div className="flex items-center justify-between">
                      <span className="text-[10px] font-semibold text-[#6E6E73]">{s.number}</span>
                      {s.status === 'active' && <CircleDot className="w-2.5 h-2.5 text-emerald-500 animate-pulse" />}
                      {s.status === 'transition' && <CircleDot className="w-2.5 h-2.5 text-[#0071E3]" />}
                    </div>
                    <div className="mt-2">
                      ...
                      <span className="text-[8px] font-medium uppercase block mt-0.5 text-[#6E6E73]">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-8 max-w-7xl mx-auto items-stretch">
          ...
          <div className="lg:col-span-5 space-y-4">
            <span className="text-[10px] font-semibold text-[#6E6E73] uppercase tracking-wider block">Select Milestone Stage</span>
            <div className="relative pl-4 border-l border-[#E8E8ED] space-y-4 py-1">
              {VISION_STAGES.map((s) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full p-4 rounded-2xl border text-left transition-all duration-200 relative flex flex-col gap-2 cursor-pointer ${
                      isSelected
                        ? 'border-[#0071E3] bg-white text-[#1D1D1F] shadow-sm'
                        : 'border-[#E8E8ED] bg-[#F5F5F7]/40 text-[#6E6E73] hover:bg-[#F5F5F7]'
                    }`}
                  >
                    {/* Active side indicator */}
                    {isSelected && (
                      <span className="absolute -left-[21px] top-1/2 -translate-y-1/2 w-2.5 h-2.5 rounded-full bg-[#0071E3] border border-white z-20 shadow-sm" />
                    )}
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        {s.icon}
                        <span className="text-[10px] font-semibold text-[#6E6E73]">{s.number}</span>
                        <h3 className="text-xs font-semibold text-[#1D1D1F]">{s.title}</h3>
                      </div>
                      <span className={`px-2 py-0.5 text-[8px] font-semibold rounded-full border uppercase ${
                        ...
                        s.status === 'transition' ? 'bg-[#0071E3]/5 text-[#0071E3] border-[#0071E3]/10' :
          ...
          <div className="lg:col-span-7 border border-[#E8E8ED] rounded-[28px] bg-white p-6 sm:p-8 flex flex-col justify-between relative overflow-hidden shadow-sm">
            
            <div className="space-y-6 relative z-10">
              
              {/* Header Image */}
              <div className="relative h-48 sm:h-64 -mx-6 sm:-mx-8 -mt-6 sm:-mt-8 mb-6 overflow-hidden bg-[#F5F5F7] border-b border-[#E8E8ED]">
                <img 
              ...
              {/* Header Title bar */}
              <div className="space-y-2 border-b border-[#E8E8ED] pb-4">
                <div className="flex items-center gap-2.5">
                  <div className="w-9 h-9 rounded-lg bg-[#F5F5F7] border border-[#E8E8ED] flex items-center justify-center shadow-xs">
                    {activeStage.icon}
                  </div>
                  <div>
                    <div className="flex items-center gap-2">
                      <span className="text-[9px] font-semibold text-[#0071E3] uppercase tracking-wider">Evolution Node {activeStage.number}</span>
                      <span className={`px-2 py-0.5 rounded text-[8px] font-semibold uppercase tracking-wider ${
                        ...
                        activeStage.status === 'transition' ? 'bg-[#0071E3]/5 text-[#0071E3]' :
                    ...
                    <h3 className="text-xl font-semibold tracking-tight text-[#1D1D1F]">{activeStage.title}</h3>
                  </div>
                </div>
              </div>
              ...
              {/* Concrete Definition */}
              <div className="space-y-1">
                <span className="text-[9px] font-semibold text-[#6E6E73] uppercase tracking-wider block">Concrete Definition</span>
                <p className="text-xs sm:text-sm text-[#1D1D1F] leading-relaxed font-semibold">
              ...
              <div className="space-y-1">
                <span className="text-[9px] font-semibold text-[#6E6E73] uppercase tracking-wider block">Current Operational State</span>
                <p className="text-xs sm:text-sm text-[#424245] leading-relaxed italic">
              ...
              <div className="space-y-1">
                <span className="text-[9px] font-semibold text-[#6E6E73] uppercase tracking-wider block">Milestone Narrative & Rationale</span>
              ...
              <div className="space-y-2.5 pt-4 border-t border-[#E8E8ED]">
                <span className="text-[9px] font-semibold text-[#6E6E73] uppercase tracking-wider block">Projected Engineering Unlocks</span>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 text-[11px] text-[#424245]">
              ...
              <div className="p-4 rounded-xl bg-[#F5F5F7] border border-[#E8E8ED] text-xs flex gap-3 items-start">
                <Info className="w-4 h-4 text-[#0071E3] shrink-0 mt-0.5" />
                <div className="space-y-1">
                  <span className="text-[8px] font-semibold text-[#1D1D1F] uppercase tracking-wider block">Investor & Talent Disclosure</span>
            ...
            <div className="mt-8 pt-4 border-t border-[#E8E8ED] flex items-center justify-between text-[10px] text-[#6E6E73]">
              <span>Audit Hash: SHA-256 Verified</span>
              <span className="text-[#0071E3] font-semibold uppercase">Mashnu Platform Track</span>
            </div>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          {/* For Investors block */}
          <div className="border border-[#E8E8ED] rounded-[24px] bg-white p-6 sm:p-8 space-y-4 flex flex-col justify-between hover:border-[#D2D2D7] transition-colors relative overflow-hidden shadow-xs">
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                <Landmark className="w-5 h-5 text-[#0071E3]" />
                <h3 className="text-sm font-semibold uppercase tracking-wider text-[#1D1D1F]">Capital Allocations & Partners</h3>
              </div>
            ...
            <Link 
              to="/contact" 
              className="text-xs font-semibold uppercase text-[#0071E3] hover:underline flex items-center gap-1 mt-4 border-t border-[#E8E8ED] pt-3"
            >
          ...
          <div className="border border-[#E8E8ED] rounded-[24px] bg-white p-6 sm:p-8 space-y-4 flex flex-col justify-between hover:border-[#D2D2D7] transition-colors relative overflow-hidden shadow-xs">
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                <Code className="w-5 h-5 text-[#0071E3]" />
                <h3 className="text-sm font-semibold uppercase tracking-wider text-[#1D1D1F]">Engineering Principles</h3>
              </div>
              <p className="text-xs text-[#6E6E73] leading-relaxed">

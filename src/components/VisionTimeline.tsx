...
export default function VisionTimeline() {
  return (
    <div className="max-w-3xl mx-auto space-y-8 py-4 animate-fade-in">
      ...
      <div className="relative p-6 sm:p-8 rounded-2xl border border-slate-900 bg-gradient-to-br from-slate-950 via-slate-950 to-slate-900 text-slate-300 font-serif leading-relaxed text-base italic space-y-4">
        ...
        <p className="relative z-10 pl-4 font-sans not-italic text-sm text-slate-400">
          <strong className="text-slate-100 block text-base font-display font-bold not-italic tracking-tight mb-2">Our Stance Against the AI Consulting Trap</strong>
        ...
        <div className="pt-4 border-t border-slate-900 not-italic flex items-center justify-between">
          <div>
            <span className="text-xs font-semibold text-slate-200 block font-display">The Engineering Team</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
        ...
        <div className="p-5 rounded-xl border border-slate-900 bg-slate-950/40 space-y-2">
          <Shield className="w-5 h-5 text-cyan-400" />
          <h4 className="text-xs font-bold font-display uppercase tracking-wider text-slate-100">For Investors</h4>
        ...
        <div className="p-5 rounded-xl border border-slate-900 bg-slate-950/40 space-y-2">
          ...
          <h4 className="text-xs font-bold font-display uppercase tracking-wider text-slate-100">For Future Hires</h4>
          <p className="text-xs text-slate-400 leading-relaxed font-sans">
